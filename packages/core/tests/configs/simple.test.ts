...
describe("test simple config", () => {
  ...
  describe("defaults values", () => {
    ...
    test("label", () => {
      const children_full_str =
        /** @tw */ "text-blue-100 text-blue-200 bg-green-500 text-sm";
  ...
  describe("with variants other than default", () => {
    test("root", () => {
      const root_full_str =
        /** @tw */ "text-red-100 text-red-200 bg-red-500 text-md";
      expect(root({ size: "medium" })).toBe(root_full_str);
    });

    test("label", () => {
      const children_full_str =
        /** @tw */ "text-blue-100 text-blue-200 text-sm";
